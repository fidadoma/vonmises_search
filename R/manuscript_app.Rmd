...
df_exp1b %>% 
  ggplot(aes(x = targetk, y = accuracy) + 
    facet_grid(~restk, 
               labeller = labeller(
        xfacet = c(`2` = expression("Target's"~kappa~"=2"), 
                   `4` = expression("Target's"~kappa~"=4"),
                   `8` = expression("Target's"~kappa~"=8"),
                   `16` = expression("Target's"~kappa~"=16"),
                   `64` = expression("Target's"~kappa~"=64"))
